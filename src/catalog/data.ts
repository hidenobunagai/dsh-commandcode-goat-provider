...
export const CATALOG: readonly CatalogEntry[] = [
  ...
  { id: 'meta/muse-spark-1.3-contributor', name: 'Muse Spark 1.3 Contributor', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'medium', tier: 'go', label: 'Go/GOAT', intelligence: 56.8, inputPrice: 0.10, outputPrice: 0.20, latest: true },
  ...
  { id: 'meta/muse-spark-1.2-contributor', name: 'Muse Spark 1.2 Contributor', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'medium', tier: 'go', label: 'Go/GOAT', intelligence: 56.8, inputPrice: 0.10, outputPrice: 0.20 },
