...
export const CATALOG: readonly CatalogEntry[] = [
  ...
  { id: 'gpt-6-astra', name: 'GPT-6 Astra', contextWindow: 1050000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'medium', tier: 'provider', label: 'Provider', intelligence: 52.7, inputPrice: 10.00, outputPrice: 50.00, latest: true },
  { id: 'gpt-6-sol', name: 'GPT-6 Sol', contextWindow: 1050000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'medium', tier: 'pro', label: 'Pro', intelligence: 47.5, inputPrice: 2.00, outputPrice: 10.00, latest: true },
  { id: 'gpt-6-luna', name: 'GPT-6 Luna', contextWindow: 1050000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'medium', tier: 'go', label: 'Go/GOAT', intelligence: 37.3, inputPrice: 0.10, outputPrice: 0.50, latest: true },
  ...
  { id: 'xai/grok-4.7', name: 'Grok 4.7', contextWindow: 500000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh'], defaultEffort: 'medium', tier: 'goat', label: 'GOAT', inputPrice: 2.00, outputPrice: 6.00, latest: true },
  ...
  { id: 'deepseek/deepseek-v4.1-flash', name: 'DeepSeek V4.1 Flash', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['high', 'max'], defaultEffort: 'high', tier: 'go', label: 'Go/GOAT', inputPrice: 0.15, outputPrice: 0.60, latest: true },
  ...
  { id: 'Qwen/Qwen3.8-Omni-Flash', name: 'Qwen 3.8 Omni Flash', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'xhigh'], defaultEffort: 'medium', tier: 'go', label: 'Go/GOAT', inputPrice: 0.15, outputPrice: 0.47, latest: true },
  ...
  { id: 'z-ai/glm-5.3-flashx', name: 'GLM-5.3 FlashX', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'high', 'max'], defaultEffort: 'high', tier: 'go', label: 'Go/GOAT', inputPrice: 0.37, outputPrice: 1.25, latest: true },
  ...
  { id: 'meta/muse-spark-1.3', name: 'Muse Spark 1.3', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'medium', tier: 'goat', label: 'GOAT', intelligence: 56.8, inputPrice: 1.25, outputPrice: 4.25, latest: true },
  { id: 'meta/muse-spark-1.3-contributor', name: 'Muse Spark 1.3 Contributor', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh'], defaultEffort: 'medium', tier: 'go', label: 'Go/GOAT', intelligence: 56.8, inputPrice: 0.10, outputPrice: 0.20, latest: true },
  { id: 'meta/muse-spark-1.2', name: 'Muse Spark 1.2', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'medium', tier: 'goat', label: 'GOAT', intelligence: 56.8, inputPrice: 1.25, outputPrice: 4.25 },
  { id: 'meta/muse-spark-1.2-contributor', name: 'Muse Spark 1.2 Contributor', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh'], defaultEffort: 'medium', tier: 'go', label: 'Go/GOAT', intelligence: 56.8, inputPrice: 0.10, outputPrice: 0.20 },
  ...
  { id: 'stepfun/Step-5-Preview', name: 'Step 5 Preview', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high'], defaultEffort: 'medium', tier: 'go', label: 'Go/GOAT', inputPrice: 0.99, outputPrice: 2.82, latest: true },
  ...
  { id: 'xiaomi/mimo-v2.6-pro', name: 'MiMo V2.6 Pro', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'go', label: 'Go/GOAT', inputPrice: 0.43, outputPrice: 0.87, latest: true },
  { id: 'xiaomi/mimo-v2.6-pro-ultraspeed', name: 'MiMo V2.6 Pro UltraSpeed', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'goat', label: 'GOAT', inputPrice: 4.35, outputPrice: 8.70, latest: true },
  { id: 'xiaomi/mimo-v2.6-flash', name: 'MiMo V2.6 Flash', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'go', label: 'Go/GOAT', inputPrice: 0.14, outputPrice: 0.28, latest: true },
  ...
  { id: 'meta/muse-spark-1.1', name: 'Muse Spark 1.1', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'medium', tier: 'goat', label: 'GOAT', intelligence: 55.0, inputPrice: 1.25, outputPrice: 4.25 },
  ...
  { id: 'claude-opus-5-5', name: 'Claude Opus 5.5', contextWindow: 1000000, maxTokens: 65536, protocol: 'anthropic', modalities: ['text', 'image'], efforts: ['low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'high', tier: 'provider', label: 'Provider', inputPrice: 4.00, outputPrice: 20.00, latest: true },
