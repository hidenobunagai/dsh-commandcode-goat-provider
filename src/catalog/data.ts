...
export const CATALOG: readonly CatalogEntry[] = [
  ...
  { id: 'deepseek/deepseek-v4-pro', name: 'DeepSeek V4 Pro', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text'], efforts: ['high', 'max'], defaultEffort: 'high', tier: 'go', label: 'Go/GOAT', intelligence: 53.2, inputPrice: 0.66, outputPrice: 1.98, latest: true },
  { id: 'deepseek/deepseek-v4-flash', name: 'DeepSeek V4 Flash', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text'], efforts: ['high', 'max'], defaultEffort: 'high', tier: 'go', label: 'Go/GOAT', intelligence: 52.0, inputPrice: 0.22, outputPrice: 0.66, latest: true },
  ...
  { id: 'minimax/minimax-m3-free', name: 'MiniMax M3 (Free)', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'free', label: 'Free', intelligence: 45.4, inputPrice: 'free', outputPrice: 'free', latest: true },
  ...
  { id: 'meta/muse-spark-1.2', name: 'Muse Spark 1.2', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'goat', label: 'GOAT', intelligence: 56.8, inputPrice: 1.25, outputPrice: 4.25, latest: true },
  { id: 'meta/muse-spark-1.2-contributor', name: 'Muse Spark 1.2 Contributor', contextWindow: 1048576, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'go', label: 'Go/GOAT', intelligence: 56.8, inputPrice: 0.10, outputPrice: 0.20, latest: true },
  ...
  { id: 'stepfun/Step-3.5-Flash', name: 'Step 3.5 Flash', contextWindow: 256000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'go', label: 'Go/GOAT', intelligence: 26.5, inputPrice: 0.10, outputPrice: 0.30 },
  ...
  { id: 'tencent/hy3-paid', name: 'Hy3 Paid', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text'], tier: 'go', label: 'Go/GOAT', intelligence: 42.2, inputPrice: 0.14, outputPrice: 0.58 },
  ...
  { id: 'Qwen/Qwen3.6-Plus', name: 'Qwen 3.6 Plus', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'go', label: 'Go/GOAT', intelligence: 40.5, inputPrice: 0.50, outputPrice: 3.00 },
  { id: 'moonshotai/Kimi-K2.5', name: 'Kimi K2.5', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'go', label: 'Go/GOAT', intelligence: 36.0, inputPrice: 0.60, outputPrice: 3.00 },
  ...
  { id: 'zai-org/GLM-5', name: 'GLM-5', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text'], tier: 'go', label: 'Go/GOAT', intelligence: 40.6, inputPrice: 1.00, outputPrice: 3.20 },
  { id: 'thinkingmachines/inkling', name: 'Inkling', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'go', label: 'Go/GOAT', intelligence: 42.3, inputPrice: 1.00, outputPrice: 4.05 },
  { id: 'Qwen/Qwen3.6-Max-Preview', name: 'Qwen 3.6 Max Preview', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text'], tier: 'go', label: 'Go/GOAT', intelligence: 41.1, inputPrice: 1.30, outputPrice: 7.80 },
  { id: 'zai-org/GLM-5.1', name: 'GLM-5.1', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text'], tier: 'go', label: 'Go/GOAT', intelligence: 41.0, inputPrice: 1.40, outputPrice: 4.40 },
  ...
  { id: 'moonshotai/Kimi-K2.6', name: 'Kimi K2.6', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'go', label: 'Go/GOAT', intelligence: 45.1, inputPrice: 0.95, outputPrice: 4.00 },
  { id: 'moonshotai/Kimi-K2.7-Code-Highspeed', name: 'Kimi K2.7 Code Highspeed', contextWindow: 256000, maxTokens: 65536, protocol: 'openai', modalities: ['text'], tier: 'go', label: 'Go/GOAT', inputPrice: 1.90, outputPrice: 8.00 },
  ...
  { id: 'MiniMaxAI/MiniMax-M2.5', name: 'MiniMax M2.5', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'go', label: 'Go/GOAT', intelligence: 34.5, inputPrice: 0.30, outputPrice: 1.20 },
  { id: 'MiniMaxAI/MiniMax-M2.7', name: 'MiniMax M2.7', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text', 'image'], tier: 'go', label: 'Go/GOAT', intelligence: 38.9, inputPrice: 0.30, outputPrice: 1.20 },
  ...
  // ── Free tier extras ───────────────────────────────────────────────
  { id: 'poolside/laguna-s-2.1-free', name: 'Laguna S 2.1 Free', contextWindow: 256000, maxTokens: 65536, protocol: 'openai', modalities: ['text'], tier: 'free', label: 'Free', inputPrice: 'free', outputPrice: 'free' },
  { id: 'minimax/minimax-m2.7-free', name: 'MiniMax M2.7 Free', contextWindow: 1000000, maxTokens: 65536, protocol: 'openai', modalities: ['text'], tier: 'free', label: 'Free', intelligence: 38.9, inputPrice: 'free', outputPrice: 'free' },
